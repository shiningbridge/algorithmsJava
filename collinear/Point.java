...
public class Point implements Comparable<Point> {
    ...
    private class SlopeComparator implements Comparator<Point> {
        ...
        public int compare(Point o1, Point o2) {
            return ( (Double) Point.this.slopeTo(o1) ).compareTo( (Double) Point.this.slopeTo(o2) ); 
//            if (Point.this.slopeTo(o2) == Point.this.slopeTo(o2)) return 0;
//            else if (Point.this.slopeTo(o1) < Point.this.slopeTo(o2)) return -1;
//            else return 1;
        }
    }
